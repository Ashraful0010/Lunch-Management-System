...
public class ManagerLogin extends JFrame {
    ...
    private void initializeComponents() {
        ...
        // label - Login
        this.labellogin = new JLabel("Manager Log In");
        this.labellogin.setBounds(250, 20, 350, 60);
        // set font
        this.labellogin.setFont(new Font("Segoe UI Black", Font.BOLD, 40));
        this.panel.add(this.labellogin);

        // label - Username
        this.labelUserName = new JLabel("Username : ");
        this.labelUserName.setBounds(30, 95, 200, 50);
        // set font
        ...
        this.password.setBounds(300, 180, 250, 50);
        ...
        this.buttonlogin.setBounds(450, 260, 150, 50);
        ...
        this.panel.add(this.buttonlogin);
         ...
         this.buttonBack.setBounds(200, 260, 150, 50);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (tf1.isEmpty() || tf2.isEmpty()) {
                    ...
                    try {
                        ...
                        BufferedReader reader = new BufferedReader(new FileReader(".\\Data\\Manager_Data.txt"));
                        ...
                        for (int i = 0; i <= totalLines; i++) {
                            String line1 = Files.readAllLines(Paths.get(".\\Data\\Manager_Data.txt")).get(i);
                            if (line1.equals(username)) {
                                String line2 = Files.readAllLines(Paths.get(".\\Data\\Manager_Data.txt")).get((i + 1));
